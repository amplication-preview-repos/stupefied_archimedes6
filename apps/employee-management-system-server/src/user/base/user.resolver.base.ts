...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [UserPositions], { name: "userPositionsItems" })
  @nestAccessControl.UseRoles({
  ...
  async findUserPositionsItems(
    ...
    const results = await this.service.findUserPositionsItems(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [UserProjects], { name: "userProjectsItems" })
  @nestAccessControl.UseRoles({
  ...
  async findUserProjectsItems(
    ...
    const results = await this.service.findUserProjectsItems(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Vacations], { name: "vacationsItems" })
  @nestAccessControl.UseRoles({
    resource: "Vacations",
    action: "read",
    possession: "any",
  ...
  async findVacationsItems(
    ...
    const results = await this.service.findVacationsItems(parent.id, args);
